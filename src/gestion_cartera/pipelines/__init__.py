...
SUBJECTS = Box(
    {
        ...
        "operational": {
            ...
            "cartera_agencia": ConfigSubject(
                sql=SQL.OPERATIONAL.CARTERA_AGENCIA,
                table=ConfigManager.table.opr.cartera_agencia,
                transformer_key=None,
            ),
            "cartera_asesor": ConfigSubject(
                sql=SQL.OPERATIONAL.CARTERA_ASESOR,
                table=ConfigManager.table.opr.cartera_asesor,
                transformer_key=None,
            ),
        },
    }
